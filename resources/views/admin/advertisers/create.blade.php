@extends('admin.layouts.app', [
    'title' => 'Register Advertiser | Hyper Adz Admin'
])
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Add Advertiser</h1>
            <p class="text-xs text-slate-500 mt-0.5">Register a new advertiser account profile manually with corporate specifications.</p>
        </div>
    </div>

    <!-- Error Block -->
    @if ($errors->any())
        <div class="p-4 bg-red-50 border border-red-100 dark:bg-red-950/10 dark:border-red-900/30 text-red-650 dark:text-red-450 rounded-2xl text-xs space-y-1">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700/50 shadow-sm overflow-hidden p-6 sm:p-8">
        <form method="POST" action="{{ route('admin.advertisers.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-550 dark:text-slate-450">Company / Brand Name <span class="text-red-500">*</span></label>
                        <input type="text" name="company_name" value="{{ old('company_name') }}" required placeholder="e.g. Multitude Solutions" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="contact_person" value="{{ old('contact_person') }}" required placeholder="Contact name" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required placeholder="you@company.com" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="website" value="{{ old('website') }}" placeholder="www.company.com" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="gst_number" value="{{ old('gst_number') }}" placeholder="e.g. 33AAAAA0000A1Z1" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                    ...
                    <!-- Logo file -->
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-550 dark:text-slate-455">Company Logo</label>
                        ...
                        <span class="block text-[10px] text-slate-400">Max size 5MB. JPG or PNG.</span>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="address_line_1" value="{{ old('address_line_1') }}" placeholder="Office number, street details..." class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                    <div class="space-y-1.5">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mt-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="postal_code" value="{{ old('postal_code') }}" placeholder="641006" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="notes" rows="3" placeholder="Add administrative details, marketing plans..." class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 rounded-xl text-sm text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#1155CC] transition-all">{{ old('notes') }}</textarea>
            </div>
